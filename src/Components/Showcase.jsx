      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center md:justify-start items-end gap-2 sm:gap-3 md:gap-1 overflow-hidden">
        {images.map((image, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`group w-[48%] sm:w-[48%] md:w-[180px] lg:w-[220px] h-[300px] sm:h-[400px] relative overflow-hidden transform ${verticalShift} transition-all duration-300
                md:[clip-path:polygon(15%_0,_100%_0,_85%_100%,_0%_100%)]`}
            >
              {/* Background Image */}
              <img
                src={image}
