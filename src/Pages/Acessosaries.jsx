    ...
    <div className="px-4 md:px-8 py-12 max-w-[1600px] mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-2 max-w-xl mx-auto">
          Browse our exclusive accessories to complement your traditional look.
        </p>
      </div>

      {loading ? (
        <p className="text-center text-gray-500 text-lg">Loading accessories...</p>
      ) : products.length === 0 ? (
        <p className="text-center text-gray-500 text-lg">No accessories found.</p>
      ) : (
